...
> [!NOTE]
> Quand ton score est satisfaisant, passe à la **[pratique pas-à-pas (venv + Docker)](./Module-00-pratique-hello-world-venv-Docker.md)** pour faire tourner ton premier Hello World, puis lis le **[Module 1 — Hello World LangChain](./01-cours.md)** pour comprendre le code en détail.
