...
# Module 0c — Pratique : Hello World en venv et en Docker
...
> [!NOTE]
> Le double dossier (`01-...hello-world/langchain-course-project-hello-world`) est volontaire : le dossier extérieur regroupe la doc (`01-cours.md`, `02-commandes.md`...) et le dossier intérieur contient le code Python.
