...
> Ce quiz teste ta compréhension du **[Module 0 — Introduction](./Module-00-introduction-LLM-LangChain-LangGraph-agent-RAG.md)**. Les 50 questions sont en QCM avec une seule bonne réponse. Lis chaque question, choisis ta réponse, puis déroule **« Réponse »** pour vérifier.

> [!NOTE]
> Objectif : valider la **carte mentale** avant d'attaquer le code du Module 1. Si tu obtiens moins de 35/50, relis les sections concernées du Module 0 avant de continuer.
...
| -------- | ------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------- |
| 45 → 50  | Excellent : ta carte mentale est solide.                                                                | Tu peux passer à la [Pratique 1 (OpenAI)](./Module-00-pratique-1-OpenAI-clef-API.md) ou la [Pratique 2 (Ollama)](./Module-00-pratique-2-Ollama-local.md) directement. |
| 35 → 44  | Bon niveau : tu as l'essentiel, quelques zones grises.                                                  | Relis les sections où tu as fait des erreurs.                   |
| 25 → 34  | Niveau partiel : la plupart des notions sont floues.                                                    | Relis le [Module 0 — Introduction](./Module-00-introduction-LLM-LangChain-LangGraph-agent-RAG.md) avant le code. |
| < 25     | Tu es en train d'apprendre, c'est normal.                                                               | Reprends le Module 0 section par section, puis refais le quiz. |
...
| Questions   | Section du [Module 0 — Introduction](./Module-00-introduction-LLM-LangChain-LangGraph-agent-RAG.md)            |
| ----------- | -------------------------------------------------------------------- |
...
> [!NOTE]
> Quand ton score est satisfaisant, choisis ta voie pour le Hello World :
> - **[Pratique 1 — OpenAI clé API](./Module-00-pratique-1-OpenAI-clef-API.md)** (qualité max, 5 USD min sur le compte OpenAI)
> - **[Pratique 2 — Ollama local](./Module-00-pratique-2-Ollama-local.md)** (gratuit, 100 % local)
>
> Garde le **[résumé des commandes](./Module-00-resume-commandes-hello-world-LangChain.md)** ouvert pour les commandes à copier-coller. Pour passer au module suivant, ouvre **[Module 2 — Search Agent](../02-langchain-course-project-search-agent/01-cours.md)**.
