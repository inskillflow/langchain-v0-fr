...
| 13  | Pratique Hello World : [Pratique 1 (OpenAI)](./Module-00-pratique-1-OpenAI-clef-API.md) · [Pratique 2 (Ollama)](./Module-00-pratique-2-Ollama-local.md) |
...
> [!NOTE]
> Ce module ne contient **aucune** ligne de code à exécuter. C'est un cours de vocabulaire et de concepts. Le code commence avec une des 2 pratiques pas-à-pas : [Pratique 1 — OpenAI](./Module-00-pratique-1-OpenAI-clef-API.md) (payant) ou [Pratique 2 — Ollama](./Module-00-pratique-2-Ollama-local.md) (gratuit).
...
→ Pour la pratique pas-à-pas, choisis ta voie : **[Pratique 1 — OpenAI](./Module-00-pratique-1-OpenAI-clef-API.md)** (payant, qualité max) ou **[Pratique 2 — Ollama](./Module-00-pratique-2-Ollama-local.md)** (gratuit, local).
→ Ensuite : choisis ta pratique selon ton fournisseur LLM, **[Pratique 1 — OpenAI](./Module-00-pratique-1-OpenAI-clef-API.md)** ou **[Pratique 2 — Ollama](./Module-00-pratique-2-Ollama-local.md)** : ton premier appel LLM avec un `PromptTemplate` et l'opérateur `|`, étape par étape.
