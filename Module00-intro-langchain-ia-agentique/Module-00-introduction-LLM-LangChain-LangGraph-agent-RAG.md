...
| 13  | [Pratique Hello World (venv + Docker)](./Module-00-pratique-introduction-LLM-LangChain-LangGraph-agent-RAG.md)              |
...
→ Pour la pratique pas-à-pas (venv + Docker) : **[Module 0c — Pratique Hello World](./Module-00-pratique-introduction-LLM-LangChain-LangGraph-agent-RAG.md)**.
